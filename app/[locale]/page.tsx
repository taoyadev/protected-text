...
import { ArrowRight, CheckCircle2, Lock, Shield, Zap, RefreshCw, Code, FileText, Github, Mail, Heart } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto flex w-full max-w-5xl flex-col gap-16 px-6 py-12">
          <section className="text-center space-y-6">
            <div className="animate-fade-in">
              <p className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2 text-xs uppercase tracking-[0.2em] text-white/90 backdrop-blur-md shadow-lg shadow-primary-900/20 hover:bg-white/15 transition-all duration-300">
                ...
                <ul className="mt-6 space-y-5 text-sm text-white/90">
                  {highlights.map((item, index) => (
                    <li key={index} className="flex items-start gap-4 group/item">
                      ...
                      <div>
                        <p className="font-bold text-white group-hover/item:text-primary-100 transition-colors duration-300">{item.title}</p>
                        <p className="mt-1 text-white/80 leading-relaxed">{item.description}</p>
                      </div>
                    </li>
                  ))}
                </ul>
        ...
        <section className="group rounded-3xl border border-white/20 bg-gradient-to-br from-slate-900/60 via-slate-900/40 to-slate-950/60 p-10 backdrop-blur-xl shadow-2xl shadow-black/20 hover:border-white/30 transition-all duration-500">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-2xl font-bold text-white">{t('landing.why.title')}</h2>
            <p className="mt-6 text-lg leading-relaxed text-white/80"
              dangerouslySetInnerHTML={{
                __html: t('landing.why.stats1')
                  .replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                  .replace(/\*(.+?)\*/g, '<span class="italic text-white">$1</span>')
              }}
            />
            ...
            <h3 className="mt-8 text-xl font-bold text-white">{t('landing.why.whatMakesDifferent.heading')}</h3>
            <p className="mt-4 text-base leading-relaxed text-white/80"
              dangerouslySetInnerHTML={{
            ...
            <h3 className="mt-8 text-xl font-bold text-white">{t('landing.why.howItWorks.heading')}</h3>
            <p className="mt-4 text-base leading-relaxed text-white/80"
              dangerouslySetInnerHTML={{
            ...
            <div className="mt-8 rounded-2xl border border-primary-400/30 bg-slate-950/60 p-6">
              <h4 className="font-bold text-white text-base">{t('landing.why.realTalk.heading')}</h4>
              <div className="mt-4 space-y-3 text-sm text-white/80">
                <p dangerouslySetInnerHTML={{
                  __html: '• ' + t('landing.why.realTalk.stat1').replace(/\*\*(.+?)\*\*/g, '<span class="font-semibold text-white">$1</span>')
                }} />
                <p dangerouslySetInnerHTML={{
                  __html: '• ' + t('landing.why.realTalk.stat2').replace(/\*\*(.+?)\*\*/g, '<span class="font-semibold text-white">$1</span>')
                }} />
                <p dangerouslySetInnerHTML={{
                  __html: '• ' + t('landing.why.realTalk.stat3').replace(/\*\*(.+?)\*\*/g, '<span class="font-semibold text-white">$1</span>')
                }} />
                <p dangerouslySetInnerHTML={{
                  __html: '• ' + t('landing.why.realTalk.stat4').replace(/\*\*(.+?)\*\*/g, '<span class="font-semibold text-white">$1</span>')
                }} />
              </div>
            ...
            <div className="mt-8 inline-flex w-full items-center justify-center gap-3 rounded-2xl border border-primary-400/40 bg-gradient-to-r from-primary-500/20 via-primary-600/15 to-indigo-500/20 px-8 py-4 shadow-lg shadow-primary-900/30 backdrop-blur-sm hover:border-primary-400/60 hover:shadow-primary-900/40 transition-all duration-300">
              <Shield className="h-6 w-6 text-primary-300 drop-shadow-lg" />
            ...
            <p className="mt-5 text-center text-base italic text-white/70 leading-relaxed">
              {t('landing.why.zeroKnowledge.tagline')}
            </p>
          </div>
        </section>

        <section id="security" className="group rounded-3xl border border-white/20 bg-gradient-to-br from-slate-950/80 via-slate-900/60 to-slate-950/80 p-10 shadow-2xl shadow-black/40 backdrop-blur-xl hover:border-white/30 hover:shadow-primary-900/20 transition-all duration-500">
          <div className="flex flex-col gap-8">
            <div>
              <h2 className="text-2xl font-bold text-white">{t('landing.security.title')}</h2>
              <p className="mt-3 text-base text-white/80">{t('landing.security.subtitle')}</p>
              <ul className="mt-6 space-y-5 text-white/80">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary-400" />
                  <div>
                    <p className="font-semibold text-white">{t('landing.security.items.passwordNeverLeaves.title')}</p>
                    <p className="text-sm text-white/70 mt-1">{t('landing.security.items.passwordNeverLeaves.description')}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary-400" />
                  <div>
                    <p className="font-semibold text-white">{t('landing.security.items.clientSideEncryption.title')}</p>
                    <p className="text-sm text-white/70 mt-1">{t('landing.security.items.clientSideEncryption.description')}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary-400" />
                  <div>
                    <p className="font-semibold text-white">{t('landing.security.items.zeroTracking.title')}</p>
                    <p className="text-sm text-white/70 mt-1">{t('landing.security.items.zeroTracking.description')}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary-400" />
                  <div>
                    <p className="font-semibold text-white">{t('landing.security.items.openSource.title')}</p>
                    <p className="text-sm text-white/70 mt-1">{t('landing.security.items.openSource.description')}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary-400" />
                  <div>
                    <p className="font-semibold text-white">{t('landing.security.items.doubleLayerProtection.title')}</p>
                    <p className="text-sm text-white/70 mt-1">{t('landing.security.items.doubleLayerProtection.description')}</p>
                  </div>
                </li>
              </ul>
            </div>
            <div className="rounded-2xl border border-primary-500/30 bg-gradient-to-br from-slate-900/80 to-slate-950/80 p-8 shadow-lg shadow-primary-900/10 backdrop-blur-sm">
              <h3 className="font-bold text-white text-base flex items-center gap-2">
                <Code className="h-5 w-5 text-primary-400" />
                {t('landing.security.technical.heading')}
              </h3>
              <p className="mt-2 text-sm text-white/70">{t('landing.security.technical.subtitle')}</p>
              <div className="mt-6 grid gap-5 text-sm text-white/70 sm:grid-cols-2">
                <div className="group/tech flex items-start gap-3 rounded-xl border border-white/10 bg-slate-950/50 p-4 hover:border-primary-400/30 hover:bg-slate-950/80 transition-all duration-300">
                  <div className="rounded-lg bg-primary-500/10 p-2 ring-1 ring-primary-400/20">
                    <Code className="h-4 w-4 text-primary-400" />
                  </div>
                  <div>
                    <p className="font-semibold text-white group-hover/tech:text-primary-200 transition-colors">{t('landing.security.technical.specs.aes256.title')}</p>
                    <p className="text-xs text-white/60 mt-1">{t('landing.security.technical.specs.aes256.description')}</p>
                  </div>
                </div>
                <div className="group/tech flex items-start gap-3 rounded-xl border border-white/10 bg-slate-950/50 p-4 hover:border-primary-400/30 hover:bg-slate-950/80 transition-all duration-300">
                  <div className="rounded-lg bg-primary-500/10 p-2 ring-1 ring-primary-400/20">
                  ...
                  <div>
                    <p className="font-semibold text-white group-hover/tech:text-primary-200 transition-colors">{t('landing.security.technical.specs.pbkdf2.title')}</p>
                    <p className="text-xs text-white/60 mt-1">{t('landing.security.technical.specs.pbkdf2.description')}</p>
                  </div>
                </div>
                <div className="group/tech flex items-start gap-3 rounded-xl border border-white/10 bg-slate-950/50 p-4 hover:border-primary-400/30 hover:bg-slate-950/80 transition-all duration-300">
                  <div className="rounded-lg bg-primary-500/10 p-2 ring-1 ring-primary-400/20">
                  ...
                  <div>
                    <p className="font-semibold text-white group-hover/tech:text-primary-200 transition-colors">{t('landing.security.technical.specs.uniqueSaltIV.title')}</p>
                    <p className="text-xs text-white/60 mt-1">{t('landing.security.technical.specs.uniqueSaltIV.description')}</p>
                  </div>
                </div>
                <div className="group/tech flex items-start gap-3 rounded-xl border border-white/10 bg-slate-950/50 p-4 hover:border-primary-400/30 hover:bg-slate-950/80 transition-all duration-300">
                  <div className="rounded-lg bg-primary-500/10 p-2 ring-1 ring-primary-400/20">
                  ...
                  <div>
                    <p className="font-semibold text-white group-hover/tech:text-primary-200 transition-colors">{t('landing.security.technical.specs.webCrypto.title')}</p>
                    <p className="text-xs text-white/60 mt-1">{t('landing.security.technical.specs.webCrypto.description')}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start">
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl font-semibold text-white">{t('landing.conflictProtection.title')}</h3>
              </div>
            ...
            <div className="flex items-center justify-center rounded-2xl border border-white/10 bg-slate-950/60 p-8 md:w-64">
              <div className="text-center">
                ...
                <p className="mt-3 text-sm font-medium text-white">{t('landing.conflictProtection.versionHistory.title')}</p>
                <p className="mt-1 text-xs text-white/60">{t('landing.conflictProtection.versionHistory.subtitle')}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="rounded-3xl border border-white/10 bg-slate-900/60 p-8">
          <div className="text-center">
            <h2 className="text-3xl font-semibold text-white">{t('landing.features.title')}</h2>
        ...
        <section className="rounded-3xl border border-white/10 bg-slate-900/60 p-10">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-white">{t('landing.gettingStarted.title')}</h2>
            <p className="mt-3 text-base text-white/70">{t('landing.gettingStarted.subtitle')}</p>
            <div className="mx-auto mt-6 max-w-3xl space-y-6 text-left">
              <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-white">{t('landing.gettingStarted.steps.step1.title')}</h3>
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-white">{t('landing.gettingStarted.steps.step2.title')}</h3>
                    <p className="mt-1 text-sm text-white/70">
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-white">{t('landing.gettingStarted.steps.step3.title')}</h3>
                    <p className="mt-1 text-sm text-white/70">
        ...
        <section id="faq" className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900/70 via-slate-900/50 to-slate-950/70 p-10 backdrop-blur-sm">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white">{t('landing.faq.title')}</h2>
            <p className="mt-3 text-base text-white/60">{t('landing.faq.subtitle')}</p>
          </div>
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            <article className="rounded-2xl border border-white/10 bg-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/30 hover:bg-slate-950/60">
              ...
              <p className="mt-3 text-base leading-relaxed text-white/80"
                dangerouslySetInnerHTML={{
                  __html: t('landing.faq.questions.forgotPassword.a').replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                }}
              />
            </article>
            <article className="rounded-2xl border border-white/10 bg-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/30 hover:bg-slate-950/60">
              ...
              <p className="mt-3 text-base leading-relaxed text-white/80"
                dangerouslySetInnerHTML={{
                  __html: t('landing.faq.questions.actuallyFree.a').replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                }}
              />
            </article>
            <article className="rounded-2xl border border-white/10 bg-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/30 hover:bg-slate-950/60">
              ...
              <p className="mt-3 text-base leading-relaxed text-white/80"
                dangerouslySetInnerHTML={{
                  __html: t('landing.faq.questions.hackServers.a').replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                }}
              />
            </article>
            <article className="rounded-2xl border border-white/10 bg-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/30 hover:bg-slate-950/60">
            ...
            <article className="rounded-2xl border border-white/10 bg-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/30 hover:bg-slate-950/60">
              ...
              <p className="mt-3 text-base leading-relaxed text-white/80"
                dangerouslySetInnerHTML={{
                  __html: t('landing.faq.questions.governmentRequest.a').replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                }}
              />
            </article>
            <article className="rounded-2xl border border-white/10 bg-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/30 hover:bg-slate-950/60">
              ...
              <p className="mt-3 text-base leading-relaxed text-white/80"
                dangerouslySetInnerHTML={{
                  __html: t('landing.faq.questions.whyTrust.a').replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                }}
              />
            </article>
            <article className="rounded-2xl border border-primary-400/20 bg-gradient-to-br from-primary-500/10 to-slate-950/40 p-6 transition-all duration-300 hover:border-primary-400/40 hover:from-primary-500/15">
              <h3 className="text-lg font-semibold text-white flex items-start gap-2">
                <span className="text-primary-400">Q:</span>
              ...
              <p className="mt-3 text-base leading-relaxed text-white/80"
                dangerouslySetInnerHTML={{
                  __html: t('landing.faq.questions.protectedTextPro.a').replace(/\*\*(.+?)\*\*/g, '<span class="font-bold text-white">$1</span>')
                }}
              />
            ...
            <div className="grid gap-10 md:grid-cols-3">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-white">Protected Text</h3>
                </div>
