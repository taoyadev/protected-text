...
export const landing = {
  ...
  footer: {
    about: {
      description:
        'Зашифрованные заметки с нулевым знанием. Ваш пароль никогда не покидает ваше устройство. Бесплатно навсегда, без отслеживания, без ерунды.',
    ...
    security: {
      ...
      description:
        'Пожалуйста, сообщите об этом ответственно по электронной почте. Мы серьёзно относимся к безопасности.',
    },
    contact: {
