...
export const pro = {
  ...
  features: {
    ...
    customDomains: {
      ...
      description: 'Utilisez votre propre domaine comme notes.votreentreprise.com au lieu de protectedtext.com/votresite',
    },
    teamSharing: {
      title: 'Partage d\'Équipe',
      description: 'Partagez des notes chiffrées avec votre équipe. Chacun obtient son propre mot de passe.',
    },
    apiAccess: {
      title: 'Accès API',
      description: 'Intégrez avec vos applications. Lisez/écrivez des notes de manière programmatique.',
    },
    fileAttachments: {
      title: 'Pièces Jointes',
      description: 'Téléchargez des fichiers chiffrés, images et documents dans vos notes.',
    },
    unlimitedRetention: {
      title: 'Rétention Illimitée',
      description: 'Conservez vos notes pour toujours. Pas de suppression automatique.',
    },
    prioritySupport: {
      title: 'Support Prioritaire',
      description: 'Obtenez de l\'aide plus rapidement quand vous en avez besoin.',
    },
  },
  ...
  feedbackForm: {
    title: 'Demander des Fonctionnalités Personnalisées pour Protected Text PRO',
    subtitle: 'Partagez vos réflexions, suggestions ou demandes de fonctionnalités pour Protected Text PRO ci-dessous.',
    ...
    emailHelp: 'Laissez votre email si vous souhaitez que nous vous recontactions',
