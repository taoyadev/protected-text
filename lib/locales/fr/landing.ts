...
export const landing = {
  ...
  why: {
    ...
    realTalk: {
      ...
      stat1: '**36 milliards d\'enregistrements de données** exposés en seulement 4 mois (janvier-avril 2024)',
      stat2: 'Moyenne de **758 288 enregistrements violés par jour** en 2024',
      stat3: 'Six méga-violations en 2024, chacune exposant **plus de 100 millions d\'enregistrements**',
      stat4: 'Le marché du chiffrement explose : de **16,7 milliards de dollars en 2024 à 60,7 milliards de dollars d\'ici 2033**',
      source: 'Sources : Rapport sur les Violations de Données 2024 du HIPAA Journal, Statista, Statistiques de Sécurité 2024 de SecureFrame',
    },

    zeroKnowledge: {
      badge: 'Architecture Zéro-Connaissance = Sécurité Sans Confiance',
      tagline: 'Vous n\'avez pas à nous faire confiance. Vous n\'avez à faire confiance à personne. Les mathématiques vous protègent, pas les promesses.',
    },
  },
  ...
  security: {
    ...
    subtitle: 'La sécurité est en fait assez simple quand on ne la complique pas. Voici exactement comment nous le faisons :',

    items: {
      passwordNeverLeaves: {
        title: 'Votre mot de passe ne quitte littéralement jamais votre appareil',
        description:
    ...
    technical: {
      ...
      specs: {
        aes256: {
          title: 'AES-256-GCM',
          description: 'Même standard utilisé par la NSA pour les documents Top Secret. Adopté par le NIST en 2001. Toujours incassable.',
        },
        pbkdf2: {
          title: 'PBKDF2 (310k itérations)',
          description: 'OWASP recommande 100k. Nous en faisons 310k pour rendre les attaques par force brute exponentiellement plus difficiles.',
        },
        uniqueSaltIV: {
          title: 'Salt et IV uniques par sauvegarde',
          description: 'Nouvelle aléatoire cryptographique à chaque fois. Pas de réutilisation, pas de prévisibilité.',
        },
        webCrypto: {
          title: 'Web Crypto API',
          description: 'Implémentation native du navigateur. Pas de bibliothèques tierces douteuses.',
        },
      },
      verifyNote: 'Vous voulez vérifier ? Le code est open source. Vérifiez-le vous-même sur GitHub.',
    },
  },
  ...
  features: {
    ...
    subtitle: 'Tout ce dont vous avez besoin. Rien que vous n\'avez pas besoin. Pas de niveaux premium.',
    list: [
  ...
  faq: {
    ...
    questions: {
      ...
      protectedTextPro: {
        ...
        linkText: 'Votez pour des fonctionnalités et aidez à façonner la feuille de route →',
      },
    },
  },
  ...
  footer: {
    about: {
      description: 'Notes chiffrées zéro-connaissance. Votre mot de passe ne quitte jamais votre appareil. Gratuit pour toujours, pas de suivi, pas de conneries.',
    ...
    security: {
      ...
      description: 'Veuillez le signaler de manière responsable par email. Nous prenons la sécurité au sérieux.',
    },
    contact: {
