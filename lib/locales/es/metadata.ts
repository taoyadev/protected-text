...
export const metadata = {
  ...
  root: {
    ...
    description: 'Bloc de notas encriptado gratis. Tu contraseña nunca sale de tu dispositivo. Sin anuncios, sin rastreo, sin tonterías. Simplemente funciona.',
    siteName: 'Protected Text',

    // Open Graph
    og: {
      title: 'Protected Text',
      description: 'Notas encriptadas. Nadie puede leerlas. Ni siquiera nosotros.',
      siteName: 'Protected Text',
    },
